...
# Data equalization
x_data_ref = np.logspace(-6, 2, 50)[::2]
...
# Plot a line
amp = 2e2
ax.plot(x_data, amp*x_data, linestyle="--", markersize=size_marker, linewidth=size_linewidth, color="Black", zorder=100, label=r"$\propto A$")
...
if flag_saveFigs == True:
    pl.savefig("{}/diabErr_1f_d.pdf".format(dirname_plots), format='pdf',bbox_inches=option_bboxinches)
