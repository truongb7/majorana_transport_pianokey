...
Average diabatic error vs. protocol time, vary noise amplitude, high frequency cut-off above minimum gap
"""
...
if flag_saveFigs == True:
    pl.savefig("{}/diabErr_white_b.pdf".format(dirname_plots), format='pdf',bbox_inches=option_bboxinches)
