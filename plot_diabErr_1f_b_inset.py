...
noise_psd_ampl = np.array([1e-6, 1e-5, 1e-4]) # Amplitude of the power spectral density (note: A = 1e-7 corresponds roughly to a variance of 1e-5)
...
ax.set_ylabel(r"$\mathcal{P}/A$", fontsize=size_axislabel_y, labelpad=8)
...
if flag_saveFigs == True:
    pl.savefig("{}/diabErr_1f_b_inset.pdf".format(dirname_plots), format='pdf',bbox_inches=option_bboxinches)
