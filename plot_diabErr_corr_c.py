...
Average/typical diabatic error vs. protocol time, vary piano key size
"""
# ------- #
# Modules #
# ------- #
...
if flag_saveFigs == True:
    pl.savefig("{}/diabErr_corr_c.pdf".format(dirname_plots), format='pdf',bbox_inches=option_bboxinches)
