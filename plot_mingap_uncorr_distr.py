...
flag_textbox = False # Display user-defined textbox
...
# Disorder
disorder_ratio = np.array([0.1125, 0.225, 0.45]) # Disorder strength (default: in units of the chemical potential
...
if flag_saveFigs == True:
    pl.savefig("{}/mingap_uncorr_distr.pdf".format(dirname_plots), format='pdf',bbox_inches=option_bboxinches)
