...
Average/typical diabatic error vs. protocol time, vary disorder strength
"""
...
disorder_ratio = np.array([0.1875, 0.375, 0.5625]) # Disorder strength (default: in units of the chemical potential difference)
...
# Data equalization
x_data_ref = np.linspace(1, 29, 15)
...
if flag_saveFigs == True:
    pl.savefig("{}/diabErr_uncorr_a.pdf".format(dirname_plots), format='pdf',bbox_inches=option_bboxinches)
