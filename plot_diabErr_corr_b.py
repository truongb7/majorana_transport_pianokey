...
Average/typical diabatic error vs. correlation length, vary disorder strength
"""
...
# Data equalization
x_data_ref = np.linspace(0.0, 1.0, 31)
...
if flag_saveFigs == True:
    pl.savefig("{}/diabErr_corr_b.pdf".format(dirname_plots), format='pdf',bbox_inches=option_bboxinches)
