...
length_corr = np.array([6.0, 8.0, 10.0]) # (GCND, SCND) Correlation length, (ECND) decay length
...
if flag_saveFigs == True:
    pl.savefig("{}/mingap_corr_disstrength_avg.pdf".format(dirname_plots), format='pdf',bbox_inches=option_bboxinches)
...
# Save figure
if flag_saveFigs == True:
    pl.savefig("{}/mingap_corr_disstrength_std.pdf".format(dirname_plots), format='pdf',bbox_inches=option_bboxinches)
