"""
Plot for diabatic error: correlated disorder 
Average/typical diabatic error vs. protocol time, vary correlation length
"""
...
length_corr = np.array([0.0, 6.0, 15.0, 30.0]) # (GCND, SCND) Correlation length, (ECND) decay length
...
if flag_saveFigs == True:
    pl.savefig("{}/diabErr_corr_a.pdf".format(dirname_plots), format='pdf',bbox_inches=option_bboxinches)
