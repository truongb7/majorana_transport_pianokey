...
Average/typical diabatic error vs. protocol time, comparison with semi-analytics
"""
...
flag_expr_diabVx_minGapAct = True
...
# Disorder
disorder_ratio = np.array([0.375]) # Disorder strength (default: in units of the chemical potential difference)
...
if flag_saveFigs == True:
    pl.savefig("{}/diabErr_uncorr_d.pdf".format(dirname_plots), format='pdf',bbox_inches=option_bboxinches)
